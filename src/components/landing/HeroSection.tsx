    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          <span className="text-hill-white">The Information Edge</span>
          <br />
        ...
        <div className="bg-hill-gray border border-hill-orange/30 rounded-lg p-4 mb-8 max-w-md mx-auto">
          <div className="flex items-center justify-center gap-3 mb-2">
            <span className="text-hill-orange font-mono text-lg font-bold">{tierName}</span>
            <span className="text-hill-muted">•</span>
            <span className="text-hill-green font-mono text-2xl font-bold">{currentPrice}</span>
            <span className="text-hill-muted text-sm">Lifetime</span>
          </div>
          {spotsRemaining > 0 && (
            <p className="text-hill-orange text-sm font-mono">
              ⚡ Only <span className="font-bold">{spotsRemaining.toLocaleString()}</span> spots at this price
            </p>
          )}
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 text-hill-muted text-sm">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-hill-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
